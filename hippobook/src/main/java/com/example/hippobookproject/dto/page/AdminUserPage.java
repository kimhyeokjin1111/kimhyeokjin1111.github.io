...
public class AdminUserPage {
    ...
    private AdminUserCriteria criteria;

    public AdminUserPage(AdminUserCriteria criteria, int total) {
        this(criteria, total, 5);
    }

    public AdminUserPage(AdminUserCriteria criteria, int total, int pageCount){
